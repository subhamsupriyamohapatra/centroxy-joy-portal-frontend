          ...
          >
            ...
            <div className="p-6 border-b border-gray-200 dark:border-gray-800 bg-gradient-to-r from-white to-gray-50 dark:from-gray-900 dark:to-[#1a2332]">
              <Link href="/admin/dashboard" className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary via-primary to-primary/80 flex items-center justify-center shadow-md">
                  <Image
                ...
                <div>
                  <h2 className="font-bold text-dark dark:text-white text-sm">Centroxy</h2>
        ...
        <header className="bg-white dark:bg-gradient-to-r dark:from-gray-900 dark:to-[#1a2332] border-b border-gray-200 dark:border-gray-800 sticky top-0 z-20 shadow-sm dark:shadow-lg">
          <div className="px-4 md:px-8 py-4 flex items-center justify-between">
            ...
            >
              ...
              <div>
                <h1 className="text-lg font-bold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent dark:from-primary/80 dark:to-primary/60">
                  Centroxy
                </h1>
              </div>
            </motion.div>
